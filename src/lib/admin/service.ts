  ...
  const updated = await prisma.$transaction(async (tx) => {
    const record = await tx.restaurant.update({
      ...
      data: {
        ...
        instagramUrl: input.instagramUrl as string | null | undefined,
        facebookUrl: input.facebookUrl as string | null | undefined,
        tiktokUrl: input.tiktokUrl as string | null | undefined,
        telegramUrl: input.telegramUrl as string | null | undefined,
